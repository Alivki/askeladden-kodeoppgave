            ...
            <section className="mt-8">
                <div className="flex items-center justify-between mb-4">
                    ...
                    {suggestions && suggestions.length === 0 ? (
                        ...
                        <div
                            className="px-4 py-2 bg-purple-600 rounded cursor-not-allowed text-sm text-white flex items-center gap-2 justify-between">
                            <Sparkles size={16}/>
                            <p>AI forslag gitt</p>
                        </div>
                    )}
                              ...
                              ({tasks.filter(task => task.status === TaskStatus.PENDING).length})
                                ...
                                <div className="space-y-3">
                                    {tasks?.filter(task => task.status === TaskStatus.PENDING).length === 0 && (
                                        <div
                                            className="p-6 bg-gray-50 border border-gray-200 rounded-lg text-center text-gray-600">
